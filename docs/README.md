...
注意：以下协议部分标记*部分为B类终端[h20,b20]支持或者针对这类设备的说明，标记#部分为A类终端[x6, b10, g15, x15, h15]支持或者针对这类设备的说明
