...
| type    | int      | 范围：241-254<br />254[0xFE]：其他<br />253[0xFD]：系统下发消息<br />252[0xFC]：系统下发消息[立即显示]<br />251[0xFB]：APP下发消息<br />250[0xFA]：APP下发消息[立即显示]<br />241-249：预留备用<br />**注意：没有该字段则识别为254其他** |
