...
| **键**  | **类型** | **含义**                                                     |
| ------- | -------- | ------------------------------------------------------------ |
| title   | string   | 短消息标题。内容格式和短消息内容的格式一致，不包含 ’msg-‘ 部分。无此键则默认标题为"Server"。 |
...
**{**"sendMsg":"1657728358,c3ae93e507c2,msg-<e8bf99e698afe4b880e69da1e6b688e681afe38082>","title":"<e9809ae79fa5>"**}**
...
| 定位类型1B[type] | 0x04: GPS定位<br />0x03：Wi-Fi定位<br />0x02：基站定位(CAT1 LBS)<br />0x01：基站定位(NB基站信息)<br />0x00/0xFF：无 |
| :--------------: | ------------------------------------------------------------ |
