...
|          | 20220721 | 1. 短消息增加标题                                            |
|          | 20220803 | 1.增加NB上报参数配置 <br />2.完善GPS参数配置 <br />3.完善蓝牙扫描参数配置 |
...
|   timeout   |   int    | 定位超时时间, 单位秒 范围10-255，**默认120** |
| bad_timeout |   int    | 信号差定位超时时间, 单位秒 范围10-255，**默认30** |
| delay_off_time | int | 用于过滤定位数据 单位秒 范围10-60，**默认10** |
